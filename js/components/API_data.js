...
export const INFO = {
    get dia_setmana() { return DATE.getDay() },
...
export const WEATHER_GET = {
    ...
    get pressió_mar() { return `${WEATHER.api_pressure_msl} hPa` },
    get pressió_superficie() { return `${WEATHER.api_surface_pressure} hPa` },
    ...
    get radiació_difusa() { return `${WEATHER.api_diffuse_radiation_instant} W/m²` },
