...
export async function apiFetch() {
  ...
  const RESPONSE = await fetch(
    `${API_URL[0][0]}${API_URL[location_number][1]}${API_URL[0][1]}${API_URL[location_number][2]}${API_URL[0][2]}${API_URL[location_number][4]}${API_URL[0][3]}${API_URL[location_number][3]}${API_URL[0][4]}`
  )
